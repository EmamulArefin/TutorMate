...
<head>
    ...
    <script src="js/UpdateInfoT.js"></script>
</head>
<body>
    <div class="updateProfile-container">
        <h2>Update Profile</h2>
        <form action="../Controllers/UpdateInfoTAction.php" method="POST" onsubmit="return Valid(this)" novalidate>
            ...
            <div class="input-group">
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="experience" name="experience" value="<?php echo htmlspecialchars($userData['Experience']); ?>">
