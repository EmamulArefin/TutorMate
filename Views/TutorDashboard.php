...
<body>
    ...
    <script>
        ...
        window.onload = function() {
            document.getElementById('info').innerHTML = "<iframe src='TutorView.php' title='Tutor View'></iframe>";
        }
        ...
        // Update the iframe source on clicking 'Update Profile'
            ...
            document.getElementById('info').innerHTML = "<iframe src='UpdateInfoT.php' title='Update Profile'></iframe>";
        });
    </script>
</body>
</html>
